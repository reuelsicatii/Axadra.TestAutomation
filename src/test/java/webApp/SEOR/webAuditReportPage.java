...
public class webAuditReportPage extends webAppHelper {
	...
	public void userScrollToSecuritySection() {
		...
		try {
			...
			context.getExtentTestScenario().log(Status.PASS, "PASSED");
			extentReportService.attachedScreenshotToReport(context,
					"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userScrollToSecuritySection.png?raw=true");
	...
	public void userSeesTheSecuritySectionSSLSubSectionIsCorrect() throws IOException {
		...
		try {
			...
			if (context.getDriver().findElement(subSectionElementFinder("SSL", "verdict")).getText()
				...
				context.getExtentTestScenario().log(Status.PASS, "PASSED");
				extentReportService.attachedScreenshotToReport(context,
						"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userSeesTheSecuritySectionSSLSubSectionIsCorrect.png?raw=true");
	...
	public void userSeesTheSecuritySectionMalwareSubSectionIsCorrect() throws IOException {
		...
		try {
			...
			if (context.getDriver().findElement(subSectionElementFinder("Malware", "verdict")).getText()
				...
				context.getExtentTestScenario().log(Status.PASS, "PASSED");
				extentReportService.attachedScreenshotToReport(context,
						"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userSeesTheSecuritySectionMalwareSubSectionIsCorrect.png?raw=true");
		...
		try {
			...
			try {
				...
				if (context.getDriver().findElement(subSectionElementFinder(subSectionAnchor, "verbiage")).getText()
					...
					context.getExtentTestScenario().log(Status.PASS, "PASSED");
					extentReportService.attachedScreenshotToReport(context,
							"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userSeesTheSecuritySectionHTTPSSubSectionIsCorrect.png?raw=true");
				}
	...
	public void userSeesTheSecuritySectionBlacklistedSubSectionIsCorrect() throws IOException {
		...
		try {
			...
			if (context.getDriver().findElement(subSectionElementFinder("blacklisted", "verdict")).getText()
				...
				context.getExtentTestScenario().log(Status.PASS, "PASSED");
				extentReportService.attachedScreenshotToReport(context,
						"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userSeesTheSecuritySectionBlacklistedSubSectionIsCorrect.png?raw=true");
	...
	public void userScrollToOrganicTrafficTechnicalSeoSection() {
		...
		try {
			...
			context.getWait()
					.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='technical-seo']")));
			...
			details.clear();
			details.add("Page URL: " + context.getDriver().getCurrentUrl());
			extentReportService.insertPassedStep(context, "User scroll to Organic Traffic > Technical SEO Section",
					details);
			...
			try {
				...
				details.add("Page URL: " + context.getDriver().getCurrentUrl());
				details.add("Error Message: " + e.getMessage());
				extentReportService.insertFailedStep(context, "User scroll to Organic Traffic > Technical SEO Section",
						details);
	...
	public void userScrollToOrganicTrafficOnPageSeoSection() {
		...
		try {
			...
			details.clear();
			details.add("Page URL: " + context.getDriver().getCurrentUrl());
			extentReportService.insertPassedStep(context, "User scroll to Organic Traffic > On-Page SEO Section",
					details);
			...
			try {
				...
				details.add("Page URL: " + context.getDriver().getCurrentUrl());
				details.add("Error Message: " + e.getMessage());
				extentReportService.insertFailedStep(context, "User scroll to Organic Traffic > On-Page SEO Section",
						details);
	...
	public void userScrollToOrganicTrafficOffPageSeoSection() {
		...
		try {
			...
			details.clear();
			details.add("Page URL: " + context.getDriver().getCurrentUrl());
			extentReportService.insertPassedStep(context, "User scroll to Organic Traffic > Off-Page SEO Section",
					details);
			...
			try {
				...
				details.add("Page URL: " + context.getDriver().getCurrentUrl());
				details.add("Error Message: " + e.getMessage());
				extentReportService.insertFailedStep(context, "User scroll to Organic Traffic > Off-Page SEO Section",
						details);
		...
		try {
			...
			try {
				...
				if (context.getDriver().findElement(subSectionElementFinder("title", "verdict")).getText()
					...
					context.getExtentTestScenario().log(Status.PASS, "PASSED");
					extentReportService.attachedScreenshotToReport(context,
							"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userSeesTheOrganicTrafficSectionOnPageSEOTitleSubSectionIsCorrect.png?raw=true");
		...
		try {
			...
			try {
				...
				if (context.getDriver().findElement(subSectionElementFinder("description", "verdict")).getText()
					...
					context.getExtentTestScenario().log(Status.PASS, "PASSED");
					extentReportService.attachedScreenshotToReport(context,
							"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userSeesTheOrganicTrafficSectionOnPageSEODescriptionSubSectionIsCorrect.png?raw=true");
		...
		try {
			...
			try {
				...
				if (context.getDriver().findElement(subSectionElementFinder("headings", "verdict")).getText()
					...
					context.getExtentTestScenario().log(Status.PASS, "PASSED");
					extentReportService.attachedScreenshotToReport(context,
							"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userSeesTheOrganicTrafficSectionOnPageSEOHeadingSubSectionIsCorrect.png?raw=true");
		...
		try {
			...
			try {
				...
				if (context.getDriver().findElement(subSectionElementFinder("Images", "verdict")).getText()
					...
					context.getExtentTestScenario().log(Status.PASS, "PASSED");
					extentReportService.attachedScreenshotToReport(context,
							"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userSeesTheOrganicTrafficSectionOnPageSEOImagesSubSectionIsCorrect.png?raw=true");
	...
	public void userScrollToSocialActivitySection() {
		...
		try {
			...
			context.getExtentTestScenario().log(Status.PASS, "PASSED");
			extentReportService.attachedScreenshotToReport(context,
					"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userScrollToSocialActivitySection.png?raw=true");
	...
	public void userSeesTheSocialActivityFacebookSubSectionIsCorrect() throws IOException {
		...
		try {
			...
			if (context.getDriver().findElement(By.xpath("//div[@id='facebook']/div[1]/div[2]")).getText()
				...
				context.getExtentTestScenario().log(Status.PASS, "PASSED");
				extentReportService.attachedScreenshotToReport(context,
						"https://github.com/reuelsicatii/Axadra.TestAutomation/blob/master/screenshots/SEOR/webAudit/userSeesTheSocialActivityFacebookSubSectionIsCorrect.png?raw=true");
