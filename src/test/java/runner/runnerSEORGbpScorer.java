...
@CucumberOptions(
		...
		monochrome = true,				
		glue = { "webApp.SEOR"},
		tags =  "@GbpScorerReportRecentReview or @GenerateGbpScorerReport or @GbpScorerReportSimilarListing or @GbpScorerReportGoogleReviewScore or @GbpScorerReportGooglePostScore",
		plugin =  {				
				"pretty",
